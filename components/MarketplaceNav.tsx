...
export default function MarketplaceNav() {
  ...
  return (
    <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-6xl">
      <div className="bg-white/10 backdrop-blur-md rounded-full border border-white/20 shadow-2xl px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 group flex-shrink-0">
            <div className="relative w-9 h-9 md:w-10 md:h-10 transform group-hover:scale-110 transition-transform duration-300">
              <Image
                src="/images/logo.png"
                alt="AgriNet Logo"
                fill
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 mt-2 mx-2 bg-white/95 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl animate-in slide-in-from-top-2 duration-200 max-h-[calc(100vh-120px)] overflow-y-auto">
