...
import { Users, Package, ShoppingCart, DollarSign, TrendingUp, Activity, AlertCircle, CheckCircle2 } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-gray-400">Manage farmers, buyers, and admins</p>
          </Link>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">Product Oversight</h3>
            <p className="text-gray-400">Monitor and moderate products</p>
          </Link>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm">Analytics will appear as platform activity increases</p>
          </div>
        </div>
      </main>
    </div>
